...
export default function ProductModal({ product, onClose }: ProductModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Only include SKU for editing existing products
      if (product) {
        payload.sku = formData.sku
      }
      // For new products, SKU will be generated by the API
            ...
            {product ? (
              <div>
                ...
                <input
                  ...
                  type="text"
                  value={formData.sku}
                  className="w-full px-3 py-2 border-2 border-gray-300 rounded bg-gray-100 font-mono"
                  disabled
                  readOnly
                />
              </div>
