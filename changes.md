# DONE
1. products / new purchases
3. purcharse histoery instead of stock history
13. stock purchases , ky investment la name change kol di to totla purschses
14. remove cashiee
6. daily , weekly and monthly etc , some expenses will be recurring so there is no place to do it in the expense tracker
4. when generatign sales reprots , if the value is in Loss (-ive) so it should show NET LOSS not NET PROFIT
11. add detailed filters for both cash and digital in the expense tracker page 
9.  just like the TOTAL line in the cutoemr ledger , the same should apply to the supplier ledger so the sales person should know how much he is gonna pay thinme
