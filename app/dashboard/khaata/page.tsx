...
import { UserCircleIcon, BuildingsIcon, MagnifyingGlassIcon, PencilSimpleIcon, TrashIcon, CaretDownIcon, CaretRightIcon, PackageIcon, CurrencyDollarIcon, ReceiptIcon } from '@phosphor-icons/react'
                            ...
                            <Fragment key={transaction.id}>
                              <tr className="bg-cyan-50 dark:bg-cyan-900/20 border-t border-cyan-200 dark:border-cyan-800">
                                <td className="px-3 py-2">
                                  ...
                                  >
                                    {txnExpanded
                                      ? <CaretDownIcon size={14} className="text-cyan-700 dark:text-cyan-300" />
                                      : <ReceiptIcon size={14} className="text-cyan-600 dark:text-cyan-400" />}
                                  </button>
                                </td>
                                ...
                                <td className="px-3 py-2">
                                  <div className="flex gap-2 justify-center">
                                    ...
                                    <button onClick={(e) => { e.stopPropagation(); handleDeleteCustomer(transaction.id) }} className="p-1.5 hover:bg-red-100 dark:hover:bg-red-900/30 rounded transition-colors text-status-error" title="Delete"><TrashIcon size={16} /></button>
                                  </div>
                                </td>
                              </tr>
