...
import { EyeIcon, EyeSlashIcon, StorefrontIcon, UserPlusIcon } from '@phosphor-icons/react'
            ...
            <>
              ...
              <div className="mb-6 border border-gray-200 rounded p-4">
                ...
                <div className="flex gap-3">
                  ...
                  >
                    <StorefrontIcon className="mx-auto mb-1" size={20} />
                  ...
                  >
                    <UserPlusIcon className="mx-auto mb-1" size={20} />
