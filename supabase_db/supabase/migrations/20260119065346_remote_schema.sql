...
CREATE OR REPLACE FUNCTION "public"."trigger_update_average_price"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "public"."trigger_update_average_price"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."update_aggregated_stock_timestamp"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "public"."update_aggregated_stock_timestamp"() OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."customer_payments" (
    ...
    CONSTRAINT "customer_payments_payment_method_check" CHECK ((("payment_method")::"text" = ANY ((ARRAY['Cash'::character varying, 'Digital'::character varying])::"text"[]))),
...
CREATE TABLE IF NOT EXISTS "public"."expenses" (
    ...
    CONSTRAINT "expenses_payment_method_check" CHECK ((("payment_method")::"text" = ANY ((ARRAY['Cash'::character varying, 'Digital'::character varying])::"text"[])))
);
...
CREATE TABLE IF NOT EXISTS "public"."join_requests" (
    ...
    CONSTRAINT "join_requests_user_type_check" CHECK ((("user_type")::"text" = ANY ((ARRAY['Manager'::character varying, 'Cashier'::character varying])::"text"[])))
);
...
CREATE TABLE IF NOT EXISTS "public"."sales" (
    ...
    CONSTRAINT "sales_discount_type_check" CHECK ((("discount_type")::"text" = ANY ((ARRAY['percentage'::character varying, 'amount'::character varying, 'none'::character varying])::"text"[]))),
    CONSTRAINT "sales_discount_value_check" CHECK (("discount_value" >= (0)::numeric)),
    CONSTRAINT "sales_payment_method_check" CHECK ((("payment_method")::"text" = ANY ((ARRAY['Cash'::character varying, 'Digital'::character varying])::"text"[]))),
    CONSTRAINT "sales_payment_status_check" CHECK ((("payment_status")::"text" = ANY ((ARRAY['Paid'::character varying, 'Partial'::character varying, 'Pending'::character varying])::"text"[]))),
...
CREATE TABLE IF NOT EXISTS "public"."supplier_khaata_payments" (
    ...
    CONSTRAINT "supplier_khaata_payments_payment_method_check" CHECK ((("payment_method")::"text" = ANY ((ARRAY['Cash'::character varying, 'Digital'::character varying])::"text"[]))),
...
CREATE TABLE IF NOT EXISTS "public"."supplier_payments" (
    ...
    CONSTRAINT "supplier_payments_payment_method_check" CHECK ((("payment_method")::"text" = ANY ((ARRAY['Cash'::character varying, 'Digital'::character varying])::"text"[])))
);
...
ALTER TABLE ONLY "public"."cashier_accounts"
    ADD CONSTRAINT "cashier_accounts_phone_number_key" UNIQUE ("phone_number");
...
CREATE OR REPLACE TRIGGER "hash_cashier_password_trigger" BEFORE INSERT ON "public"."cashier_accounts" FOR EACH ROW EXECUTE FUNCTION "public"."hash_cashier_password"();
...
CREATE OR REPLACE TRIGGER "update_aggregated_stock_updated_at" BEFORE UPDATE ON "public"."aggregated_stock" FOR EACH ROW EXECUTE FUNCTION "public"."update_aggregated_stock_timestamp"();
...
ALTER TABLE ONLY "public"."supplier_khaata"
    ADD CONSTRAINT "fk_supplier_khaata_stock_batch" FOREIGN KEY ("stock_batch_id") REFERENCES "public"."stock_batches"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."partial_payment_customers"
    ADD CONSTRAINT "partial_payment_customers_sale_id_fkey" FOREIGN KEY ("sale_id") REFERENCES "public"."sales"("id") ON DELETE CASCADE;
...
CREATE POLICY "customer_payments_delete_policy" ON "public"."customer_payments" FOR DELETE USING (("store_id" IN ( SELECT "stores"."id"
   FROM "public"."stores"
  WHERE ("stores"."created_by" = "auth"."uid"()))));



CREATE POLICY "customer_payments_insert_policy" ON "public"."customer_payments" FOR INSERT WITH CHECK (("store_id" IN ( SELECT "stores"."id"
   FROM "public"."stores"
  WHERE ("stores"."created_by" = "auth"."uid"()))));



CREATE POLICY "customer_payments_select_policy" ON "public"."customer_payments" FOR SELECT USING (("store_id" IN ( SELECT "stores"."id"
   FROM "public"."stores"
  WHERE ("stores"."created_by" = "auth"."uid"()))));



CREATE POLICY "customer_payments_update_policy" ON "public"."customer_payments" FOR UPDATE USING (("store_id" IN ( SELECT "stores"."id"
   FROM "public"."stores"
  WHERE ("stores"."created_by" = "auth"."uid"()))));
...
CREATE POLICY "supplier_khaata_delete_policy" ON "public"."supplier_khaata" FOR DELETE USING (("store_id" IN ( SELECT "stores"."id"
   FROM "public"."stores"
  WHERE ("stores"."created_by" = "auth"."uid"()))));



CREATE POLICY "supplier_khaata_insert_policy" ON "public"."supplier_khaata" FOR INSERT WITH CHECK (("store_id" IN ( SELECT "stores"."id"
   FROM "public"."stores"
  WHERE ("stores"."created_by" = "auth"."uid"()))));
...
CREATE POLICY "supplier_khaata_payments_delete_policy" ON "public"."supplier_khaata_payments" FOR DELETE USING (("store_id" IN ( SELECT "stores"."id"
   FROM "public"."stores"
  WHERE ("stores"."created_by" = "auth"."uid"()))));



CREATE POLICY "supplier_khaata_payments_insert_policy" ON "public"."supplier_khaata_payments" FOR INSERT WITH CHECK (("store_id" IN ( SELECT "stores"."id"
   FROM "public"."stores"
  WHERE ("stores"."created_by" = "auth"."uid"()))));



CREATE POLICY "supplier_khaata_payments_select_policy" ON "public"."supplier_khaata_payments" FOR SELECT USING (("store_id" IN ( SELECT "stores"."id"
   FROM "public"."stores"
  WHERE ("stores"."created_by" = "auth"."uid"()))));



CREATE POLICY "supplier_khaata_payments_update_policy" ON "public"."supplier_khaata_payments" FOR UPDATE USING (("store_id" IN ( SELECT "stores"."id"
   FROM "public"."stores"
  WHERE ("stores"."created_by" = "auth"."uid"()))));



CREATE POLICY "supplier_khaata_select_policy" ON "public"."supplier_khaata" FOR SELECT USING (("store_id" IN ( SELECT "stores"."id"
   FROM "public"."stores"
  WHERE ("stores"."created_by" = "auth"."uid"()))));



CREATE POLICY "supplier_khaata_update_policy" ON "public"."supplier_khaata" FOR UPDATE USING (("store_id" IN ( SELECT "stores"."id"
   FROM "public"."stores"
  WHERE ("stores"."created_by" = "auth"."uid"()))));
...
GRANT ALL ON FUNCTION "public"."trigger_update_average_price"() TO "anon";
GRANT ALL ON FUNCTION "public"."trigger_update_average_price"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."trigger_update_average_price"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."update_aggregated_stock_timestamp"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_aggregated_stock_timestamp"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_aggregated_stock_timestamp"() TO "service_role";
...
GRANT ALL ON TABLE "public"."aggregated_stock" TO "anon";
...
GRANT ALL ON TABLE "public"."partial_payment_customers" TO "anon";
...
GRANT ALL ON TABLE "public"."product_imeis" TO "anon";
...
GRANT ALL ON TABLE "public"."supplier_khaata" TO "anon";
...
GRANT ALL ON TABLE "public"."supplier_khaata_payments" TO "anon";
...
alter table "public"."customer_payments" drop constraint "customer_payments_payment_method_check";
...
alter table "public"."join_requests" drop constraint "join_requests_user_type_check";

alter table "public"."sales" drop constraint "sales_discount_type_check";
...
alter table "public"."supplier_khaata_payments" drop constraint "supplier_khaata_payments_payment_method_check";

alter table "public"."supplier_payments" drop constraint "supplier_payments_payment_method_check";

alter table "public"."customer_payments" add constraint "customer_payments_payment_method_check" CHECK (((payment_method)::text = ANY ((ARRAY['Cash'::character varying, 'Digital'::character varying])::text[]))) not valid;

alter table "public"."customer_payments" validate constraint "customer_payments_payment_method_check";

alter table "public"."expenses" add constraint "expenses_payment_method_check" CHECK (((payment_method)::text = ANY ((ARRAY['Cash'::character varying, 'Digital'::character varying])::text[]))) not valid;
...
alter table "public"."join_requests" add constraint "join_requests_user_type_check" CHECK (((user_type)::text = ANY ((ARRAY['Manager'::character varying, 'Cashier'::character varying])::text[]))) not valid;

alter table "public"."join_requests" validate constraint "join_requests_user_type_check";

alter table "public"."sales" add constraint "sales_discount_type_check" CHECK (((discount_type)::text = ANY ((ARRAY['percentage'::character varying, 'amount'::character varying, 'none'::character varying])::text[]))) not valid;

alter table "public"."sales" validate constraint "sales_discount_type_check";

alter table "public"."sales" add constraint "sales_payment_method_check" CHECK (((payment_method)::text = ANY ((ARRAY['Cash'::character varying, 'Digital'::character varying])::text[]))) not valid;

alter table "public"."sales" validate constraint "sales_payment_method_check";

alter table "public"."sales" add constraint "sales_payment_status_check" CHECK (((payment_status)::text = ANY ((ARRAY['Paid'::character varying, 'Partial'::character varying, 'Pending'::character varying])::text[]))) not valid;

alter table "public"."sales" validate constraint "sales_payment_status_check";

alter table "public"."supplier_khaata_payments" add constraint "supplier_khaata_payments_payment_method_check" CHECK (((payment_method)::text = ANY ((ARRAY['Cash'::character varying, 'Digital'::character varying])::text[]))) not valid;

alter table "public"."supplier_khaata_payments" validate constraint "supplier_khaata_payments_payment_method_check";

alter table "public"."supplier_payments" add constraint "supplier_payments_payment_method_check" CHECK (((payment_method)::text = ANY ((ARRAY['Cash'::character varying, 'Digital'::character varying])::text[]))) not valid;
